...
- 短报告（<100行）：用 lark-cli im +messages-send --user-id ou_ba47b9dd81419f75c4febdd199bde7d8 --markdown "内容"
- 长报告（≥100行）：必须创建飞书文档，授权 full_access，然后发飞书消息告知用户文档链接
  - 创建文档：lark-cli docs +create --title "标题" --markdown "$(cat report.md)" --as bot
  - 授权：lark-cli api POST /open-apis/drive/v1/permissions/<doc_token>/members --params '{"type":"docx"}' --data '{"member_type":"openid","member_id":"ou_ba47b9dd81419f75c4febdd199bde7d8","perm":"full_access"}' --as bot
  - 发链接：lark-cli im +messages-send --user-id ou_ba47b9dd81419f75c4febdd199bde7d8 --markdown "任务名 + 状态 + 关键结论 + 文档链接"
...
- 署名必须包含日期
- 禁止匿名产出文档
- 创建飞书文档后，必须立即给用户（ou_ba47b9dd81419f75c4febdd199bde7d8）授予 full_access 编辑权限
- 授权命令：lark-cli api POST /open-apis/drive/v1/permissions/<doc_token>/members --params '{"type":"docx"}' --data '{"member_type":"openid","member_id":"ou_ba47b9dd81419f75c4febdd199bde7d8","perm":"full_access"}' --as bot
- 未授权视为文档交付不完整
