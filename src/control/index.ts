...
// FR-K01: Main Session Async Discipline Guard
export {
...
export type {
  ...
  NormalizedKillImpactScanConfig,
  KillImpactScanResult,
  KillImpactReport,
  KillImpactFailedReport,
  KillImpactDisabledReport,
  KillImpactRiskLevel,
  KillImpactRecommendedAction,
} from './kill-impact-scan.js';
